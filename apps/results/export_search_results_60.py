...
sql = "SELECT count(results_id) from results, queries where queries_id = results_queries_id and queries_query not like '%&uule=%' and queries_studies_id = 60"
